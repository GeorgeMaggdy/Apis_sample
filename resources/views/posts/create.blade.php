...
<form action="{{route('posts.store')}}" method="post" >
  ...
  <div class="mb-3">
    ...
    <input name="title" type="text" class="form-control" class="@error('title') is_invalid @enderror" id="exampleInputEmail1" aria-describedby="emailHelp">
    @error('title')
 ...
 @enderror
  ...
  <div class="mb-3">
    ...
    <input name="posted_by" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" class="@error('posted_by') is-invalid @enderror">
    @error('posted_by')
    <div class="alert alert-danger">{{$message}}</div>
    @enderror
    <div id="emailHelp" class="form-text"></div>
